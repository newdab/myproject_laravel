...
<form method="POST" action="{{asset('admin/diadiem/add')}}" class="col-md-9 col-xs-offset-2" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<table class="table table-bordered">
		<tr>
		<td>Tên địa điểm</td>
		<td>
			<input type="text" required name="tendiadiem">
		</td>
		</tr>
		<tr>
				<td>Hình ảnh</td>
		...
		<tr>
			<td>Mô tả</td>
			<td>
				<textarea name="mota" rows="4" cols="50" id="mota" required></textarea>
		...
		<tr>
			<td>Trong nước</td>
			<td>
				<input type="checkbox" name="trongnuoc" checked>
			</td>
		</tr>
		<tr>
