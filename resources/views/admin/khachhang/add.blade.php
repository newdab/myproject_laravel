...
<form method="POST" action="{{asset('admin/khachhang/add')}}" class="col-md-9 col-xs-offset-2" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<table class="table table-bordered">
		...
		<tr>
			<td>Địa chỉ</td>
			<td><textarea name="diachi" style="width: 100%"></textarea></td>
		</tr>
		<tr>
			<td>Điện thoại</td>
			<td><input type="phone" name="dienthoai"></td>
		</tr>
		<tr>
			<td>Email</td>
			<td>
